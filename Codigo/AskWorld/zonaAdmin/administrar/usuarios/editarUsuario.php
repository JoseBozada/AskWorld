...
<?php
    ...
    //Guardamos los datos del admin en variables
...
<div class="card text-center">
    ...
    <div class="card-body">
        ...
        <form id="editarUsuario" enctype="multipart/form-data" method="post">
            <br>
            <div class="row">  
                <!-- Usuario -->
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password" id="password" class="form-control" value="<?php echo $Contraseña; ?>">
                    </div>
                </div>
                <!-- Termina Contraseña -->
        ...
        <br>
            ...
            <div class="col">
                ...
                <div class="input-group">
                    ...
                    <img src="<?php echo $Imagen; ?>" alt="avatar" width="100" height="80">
...
if(isset($_POST['actualizar'])){
	...
	if ($_FILES["img"]["name"] != '') {
		...
		if(is_uploaded_file($_FILES["img"]["tmp_name"])) {
			...
			echo "<script>alert('Actualizando usuario...')</script>";
			
			unlink($Imagen);
			
			$consulta = ActualizarUsuario($conexion, $usuario, $password, $nombre, $apellido1, $apellido2, $email, $ruta, $fecha, $direccion, $telefono, $provincia, $poblacion, $idUsuario);
			...
			echo "<script>alert('El usuario no se ha podido actualizar.')</script>";
		...
		$consulta = ActualizarUsuario($conexion, $usuario, $password, $nombre, $apellido1, $apellido2, $email, $Imagen, $fecha, $direccion, $telefono, $provincia, $poblacion, $idUsuario);
