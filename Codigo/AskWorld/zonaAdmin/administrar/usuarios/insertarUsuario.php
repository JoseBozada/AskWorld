...
<div class="card text-center">
	...
	<div class="card-body">
		...
		<form id="insertarUsuario" enctype="multipart/form-data" method="post" class="needs-validation">
			<div class="row">  
				<!-- Usuario -->
				<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="input-group">
						...
						<input type="date" name="fecha" id="fecha" min="1922-01-01" max="2009-12-31" class="form-control" required>
					</div>
				</div>
			</div>
			<!-- Termina Fecha -->
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="input-group">
						...
						<input type="text" name="poblacion" id="poblacion" class="form-control" readonly>
					</div>
				</div>
			</div>
			<!-- Termina Población -->
