...
<div class="card text-center">
    ...
    <div class="card-body">
        <img src="../../img/Usuario.png" width="150" height="150" style="border-radius: 20px;">
        ...
        <div class="row">  
				...
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="usuario" id="usuario" class="form-control" placeholder="Usuario2" autofocus>
					</div>
				</div>
				<!-- Termina Usuario -->
				...
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="nombre" id="nombre" class="form-control" placeholder="Lucas">
					</div>
				</div>
			</div>
			<!-- Termina Nombre --> 
			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="apellido" id="apellido" class="form-control" placeholder="Juan">
					</div>
				</div>
			</div>
			<!-- Termina Apellido -->
			...
			<div class="row">
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="direccion" id="direccion" class="form-control" placeholder="Calle nº1 portal">
					</div>
				</div>
				<!-- Termina Dirección -->
				...
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="apellido2" id="apellido2" class="form-control" placeholder="Antonio">
					</div>
				</div>
			</div>
			<!-- Termina Apellido 2 -->
			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="poblacion" id="poblacion" class="form-control" placeholder="Melilla">
					</div>
				</div>
			</div>
			<!-- Termina Población -->
			...
			<div class="row">
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="number" name="telefono" id="telefono" class="form-control" placeholder="123456789">
					</div>
				</div>
				<!-- Termina Teléfono -->
				...
				<div class="col">
					...
					<div class="input-group">
						...
						<input type="text" name="dni" id="dni" class="form-control" placeholder="12345678A">
					</div>
				</div>
			</div>
			<!-- Termina DNI -->
            ...
            <input name="insertar" value="Insertar Usuaio" type="submit" class="btn btn-warning form-control" style="border: black 2px solid">
        </form>
    </div>
    <div class="card-footer text-muted">
        <a href="usuarios.php">Ir a los Usuarios</a>
    </div>
</div>
