...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="display-4">Valoraciones</h1>
        <hr>
        <div class="row">
            <div class="col-sm-4">
                <a href="insertarValoracion.php" style="color: white; text-decoration:none;" class="btn btn-primary"><i class="fas fa-plus-circle"></i> INSERTAR VALORACIÓN</a>
            </div>
        </div>
        <br>
